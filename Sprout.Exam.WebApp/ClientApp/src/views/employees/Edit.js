...
export class EmployeeEdit extends Component {
  ...
  handleSalaryFocusOut(e) {
    const salaryToTwoDecimal = NumFormat().stringToNumTwoDecimal(e.target.value);
    this.setState({ salary: salaryToTwoDecimal });
  }
...
<div className='form-group col-md-6'>
  ...
  <input type='date' className='form-control' id='inputBirthdate4' onChange={this.handleChange.bind(this)} name="birthdate" value={Formatter().dateToString(this.state.birthdate)} placeholder='Birthdate' min="1900-01-01" max={Formatter().dateToString(new Date().toJSON())} />
</div>
</div>
<div className="form-row">
<div className='form-group col-md-6'>
