...
export class EmployeeCreate extends Component {
  ...
  constructor(props) {
    ...
    this.state = { fullName: '',birthdate: Formatter().dateToString(dateNow),tin: '',typeId: 1, loading: false,loadingSave:false };
  }
...
<div className='form-group col-md-6'>
  ...
  <input type='date' className='form-control' id='inputBirthdate4' onChange={this.handleChange.bind(this)} name="birthdate" value={this.state.birthdate} placeholder='Birthdate' min="1900-01-01" max={Formatter().dateToString(new Date().toJSON())} />
</div>
</div>
<div className="form-row">
<div className='form-group col-md-6'>
